...
export default function Main() {
  ...
  return (
    <div className='flex flex-col h-screen'>
      ...
      <main className='container mx-auto flex-grow flex flex-col justify-center items-center pt-4 px-2'>
        <div className='mb-16'>
      ...
      <footer className='w-full border-t h-12 flex justify-end md:justify-center items-center bg-black text-white'>
        <div className='px-4'>
          <span className='text-sm'>Created by <a href='https://twitter.com/sekiya9311' className='border-b-2 border-white'>@sekiya9311</a></span>
        </div>
      </footer>
    </div>
  )
